    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-8 sm:px-12 lg:px-16 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Trusted worldwide</h3>
            ...
            <div key={item.id} className="text-center">
              <div className="flex justify-center mb-4">
                <div
                  ...
                  style={{ backgroundColor: 'rgba(22, 198, 53, 0.1)' }}
                >
                  {item.icon}
                </div>
              </div>
              ...
              <p className="text-xl md:text-2xl font-bold mb-1" style={{ color: '#16c635' }}>
                {item.value}
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {awards.map((award, index) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 font-medium">{award}</p>
              </div>
            ))}
          </div>
        </div>
