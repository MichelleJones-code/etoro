            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <path fillRule="evenodd" d="M18 9H2v5a2 2 0 002 2h14a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm7-1a1 1 0 100 2h6a1 1 0 100-2h-6z" clipRule="evenodd" />
                </svg>
              </div>
              <div>
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">
                  Earn up to <span className="text-emerald-600">3.55%</span> annual interest
                </h3>
          ...
          <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Store, buy, sell, and transfer crypto assets with our secure and easy-to-use wallet.
                </p>
