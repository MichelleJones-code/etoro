    ...
    <footer className="bg-gray-50 text-gray-700">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Top Instruments */}
          <div>
            <h4 className="text-gray-900 font-light mb-4 text-base">Top instruments</h4>
            <ul className="space-y-2">
              {footerLinks.topInstruments.map(item => (
                <li key={item.id}>
                  <a
                    href={item.href}
                    className="hover:text-emerald-600 transition-colors text-sm font-light"
                  >
                    {item.title}
                  </a>
                </li>
          ...
          {/* Support */}
          <div>
            <h4 className="text-gray-900 font-light mb-4 text-base">Support</h4>
            <ul className="space-y-2">
          ...
          {/* Learn More */}
          <div>
            <h4 className="text-gray-900 font-light mb-4 text-base">Learn more</h4>
            <ul className="space-y-2">
          ...
          {/* About Us */}
          <div>
            <h4 className="text-gray-900 font-light mb-4 text-base">About Us</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h4 className="text-gray-900 font-light mb-4 text-base">Privacy and Regulation</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="text-gray-900 font-light mb-4 text-base">Partners and Promotions</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="text-gray-900 font-light mb-4 text-base">Find Us On</h4>
              ...
              <div className="flex space-x-4 mb-4">
                {socialLinks.map(social => (
                  <a
                    ...
                    href={social.url}
                    title={social.name}
                    className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-emerald-600 hover:text-white transition-colors text-gray-700"
                  >
          ...
          {/* Disclaimer */}
          <div className="border-t border-gray-200 pt-8 text-sm text-gray-600 font-light space-y-4">
            <p>
              eToro (Europe) Ltd., a Financial Services Company authorised and regulated by the
              Cyprus Securities Exchange Commission (CySEC) under the license # 109/10. Registered
              in Cyprus under Company No. HE 200585. Registered Office: 4 Profiti Ilia Str., Kanika
              Business Centre, 7th floor, Germasogeia, 4046, Limassol, Cyprus.
            </p>
            <p>
